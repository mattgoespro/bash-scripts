...
## Trusted Windows 10 Pro Torrents
...
### Configure integrated terminal for NPM scripts

Set the terminal that NPM scripts execute with when started from the `npm scripts` side panel view:

- `npm config set script-shell <external_shell_executable_path>`
...
- Navigate to the _Advanced_ tab
- Under the **_Virtual memory_** card, click _Settings_
